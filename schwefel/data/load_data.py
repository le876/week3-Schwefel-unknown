...
def load_raw_data():
    ...
    # 加载训练集和测试集
    x_train = np.load(os.path.join(raw_dir, 'Schwefel_x_train.npy'))
    y_train = np.load(os.path.join(raw_dir, 'Schwefel_y_train.npy'))
    x_test = np.load(os.path.join(raw_dir, 'Schwefel_x_test.npy'))
    y_test = np.load(os.path.join(raw_dir, 'Schwefel_y_test.npy'))
