...
本项目包含两个独立的机器学习任务，分别针对20D Schwefel数据集以及unknow48数据集的回归问题，目标为尽可能提升pearson ratio，进行了从传统机器学习到深度学习的多种建模方法尝试，最终选择对Schwefel使用自主设计的维度分解的神经网络架构，对于Unknown48数据集使用GBDT模型。
